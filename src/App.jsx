                            ...
                            <div className="dialog-grid" style={{display:'grid', gridTemplateColumns:'220px 1fr', gap:12}}>
                                ...
                                <div>
                                    ...
                                    <div style={{marginBottom:8}}>
                                        Classic stuffed toy collectible from the insane late-1990s Beanie Baby craze. Visualize the price collapse from the 90s peak to now - the popping of the Speculative Bubble.
                                    </div>
